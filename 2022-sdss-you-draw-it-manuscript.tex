...
\item
  \textbf{Participant Data (Nonlinear):} De-identified participant data
  collected in the study and used for analyses are available to be
  downloaded from GitHub at
...
\item
  \textbf{Data Analysis Code:} The code used to replicate the nonlinear
  study analysis in this paper can be found at
