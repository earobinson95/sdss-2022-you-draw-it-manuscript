...
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, borderline west={3pt}{0pt}{shadecolor}, frame hidden, breakable, sharp corners, interior hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
Draw It' method and analysis on nonlinear data.
...
method for flexibility due to nonlinear data, we used spaghetti plots to
conduct a visual analysis of participant forecasts compared to the
nonlinear least squares statistical model and make comparisons between
...
\item
  \textbf{`You Draw It' Code:} The `You Draw It' JavaScript code can be
  accessed at
...
\item
  ...
  collected in the study and used for analyses are available to be
  downloaded from GitHub at
  \href{https://github.com/earobinson95/log-perception-prolific/raw/main/analyses/02b-eyefitting/data/eyefitting-model-data.csv}{github.com/earobinson95/log-perception-prolific/raw/main/analyses/02b-eyefitting/data/eyefitting-model-data.csv}.
\item
  \textbf{Data Analysis Code (Linear):} The code used to replicate the
  linear study analysis in this paper can be found at
  \href{https://github.com/earobinson95/log-perception-prolific/blob/main/analyses/02b-eyefitting/eyefitting-analysis.Rmd}{github.com/earobinson95/log-perception-prolific/blob/main/analyses/02b-eyefitting/eyefitting-analysis.Rmd}.
\item
  \textbf{Participant Data (Non-linear):} De-identified participant data
  collected in the study and used for analyses are available to be
  downloaded from GitHub at
  \href{https://github.com/earobinson95/log-perception-prolific/raw/main/analyses/02a-you-draw-it/data/youdrawit-model-data.csv}{github.com/earobinson95/log-perception-prolific/raw/main/analyses/02a-you-draw-it/data/youdrawit-model-data.csv}.
\item
  \textbf{Data Analysis Code (Non-linear):} The code used to replicate
  the nonlinear study analysis in this paper can be found at
  \href{https://github.com/earobinson95/log-perception-prolific/blob/main/analyses/02a-you-draw-it/you-draw-it-analysis.Rmd}{github.com/earobinson95/log-perception-prolific/blob/main/analyses/02a-you-draw-it/you-draw-it-analysis.Rmd}.
\end{itemize}
