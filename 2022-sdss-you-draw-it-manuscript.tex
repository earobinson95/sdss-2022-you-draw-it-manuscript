...
\end{abstract}
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, enhanced, interior hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
an interactive graphic. While any communication between user and device
can be considered an interaction, interactive graphics should be defined
as a user-driven direct manipulation of plots and plotting elements with
an immediate reaction (Unwin 1999, Becker et al.~1987, Eick \& Wills
1995). Here we discuss the use of `You Draw It' as a tool for
...
graphics. We collect data of the user drawn lines and compare to
...
first encounter with the concept of statistical association (Casey and
Nagle 2016). Casey (2015) and Casey (2016) conducted task based
interviews to examine student's conceptions of the line of best fit
prior to introducing the topic. The implications of using interactive
teaching tools for the line of best fit can help students make
connections between the shift in slope and the location of the best fit
line (Nagle, Casey, and Moore-Russo 2017). Casey and Wasserman (2015)
conducted similar task based interviews wish pre-service mathematics
teachers in order to understand the implications regarding teacher
preparation for the teaching of this topic. This demonstrates the use of
the `You Draw It' interactive tool for training purposes both within a
classroom setting and for those in the workforce.
...
\leavevmode\vadjust pre{\hypertarget{ref-casey2015examining}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-casey2016finding}{}}%
---------. 2016. {``Finding What Fits.''} \emph{Mathematics Teaching in
the Middle School} 21 (8): 484--91.

\leavevmode\vadjust pre{\hypertarget{ref-casey2016students}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-casey2015teachers}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-geidner2015role}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-george2011interactive}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-george2013storytelling}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-nagle2017slope}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-pearce_2019}{}}%
