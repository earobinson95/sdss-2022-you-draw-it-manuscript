...
<!-- an interactive graphic is defined as a user-driven direct manipulation of the plot followed by an immediate reaction [@unwin1999requirements; @eick1995high; @becker1987dynamic]. -->
...
@casey2015teachers conducted similar task based interviews with pre-service mathematics teachers in order to understand the effects regarding teacher preparation for the teaching of this topic. 
