...
+ **'You Draw It' Code:** The 'You Draw It' JavaScript code can be accessed at  [github.com/earobinson95/presentations/blob/master/can-you-draw-it/www/you-draw-it.js](https://github.com/earobinson95/presentations/blob/master/can-you-draw-it/www/you-draw-it.js).
...
+ **Participant Data (Linear):** De-identified participant data collected in the study and used for analyses are available to be downloaded from GitHub at  [github.com/earobinson95/log-perception-prolific/raw/main/analyses/02b-eyefitting/data/eyefitting-model-data.csv](https://github.com/earobinson95/log-perception-prolific/raw/main/analyses/02b-eyefitting/data/eyefitting-model-data.csv). 
+ **Data Analysis Code (Linear):** The code used to replicate the linear study analysis in this paper can be found at [github.com/earobinson95/log-perception-prolific/blob/main/analyses/02b-eyefitting/eyefitting-analysis.Rmd](https://github.com/earobinson95/log-perception-prolific/blob/main/analyses/02b-eyefitting/eyefitting-analysis.Rmd).
+ **Participant Data (Non-linear):** De-identified participant data collected in the study and used for analyses are available to be downloaded from GitHub at  [github.com/earobinson95/log-perception-prolific/raw/main/analyses/02a-you-draw-it/data/youdrawit-model-data.csv](https://github.com/earobinson95/log-perception-prolific/raw/main/analyses/02a-you-draw-it/data/youdrawit-model-data.csv). 
+ **Data Analysis Code (Non-linear):** The code used to replicate the nonlinear study analysis in this paper can be found at [github.com/earobinson95/log-perception-prolific/blob/main/analyses/02a-you-draw-it/you-draw-it-analysis.Rmd](https://github.com/earobinson95/log-perception-prolific/blob/main/analyses/02a-you-draw-it/you-draw-it-analysis.Rmd).
